...
/* harmony import */ var _plugins_search_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../plugins/search-index */ "./app/javascript/plugins/search-index.js");
/* harmony import */ var _plugins_search_conseils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../plugins/search-conseils */ "./app/javascript/plugins/search-conseils.js");
/* harmony import */ var _plugins_filter_conseils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../plugins/filter-conseils */ "./app/javascript/plugins/filter-conseils.js");
...
document.addEventListener('turbolinks:load', function () {
  if (document.querySelector("#select-search-residence")) {
    ...
    //   changeTypes();
    // }
    Object(_plugins_search_index__WEBPACK_IMPORTED_MODULE_4__["searchIndex"])();
    Object(_plugins_search_index__WEBPACK_IMPORTED_MODULE_4__["updateInput"])(); // if (document.getElementById("text-to-change-residence")) {
    //   changeResidence();
    // }
  }

  if (document.querySelector("#select-search-category")) {
    Object(_plugins_search_conseils__WEBPACK_IMPORTED_MODULE_5__["searchIndexConseils"])();
    Object(_plugins_search_conseils__WEBPACK_IMPORTED_MODULE_5__["updateInputCategories"])();
  }

  var buttonsUnSelected = document.querySelectorAll(".button-criteria-selected");

  if (buttonsUnSelected) {
    Object(_plugins_filter_conseils__WEBPACK_IMPORTED_MODULE_6__["unSelectFilter"])(buttonsUnSelected);
  }

  var buttonsSelected = document.querySelectorAll(".button-criteria");

  if (buttonsSelected) {
    Object(_plugins_filter_conseils__WEBPACK_IMPORTED_MODULE_6__["selectFilter"])(buttonsSelected);
  }
...
/*!***************************************************!*\
  !*** ./app/javascript/plugins/search-conseils.js ***!
  \***************************************************/
/*! exports provided: changeCategory, updateInputCategories, searchIndexConseils */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var changeCategory = function changeCategory() {
  var categories = ["📕 administratif", "🤑 financiers", "🌟 rôle modèles", "🛠 technique", "👑 matrimoine"];
  var counter = 0;
  var element = document.getElementById("text-to-change-category");
  var inst = setInterval(function () {
...
var updateInput = function updateInput() {
  ...
  dropdownElementsResidences.forEach(function (element) {
    element.addEventListener("click", function () {
      ...
      document.getElementById("dropdown-elements-residence").classList.toggle("show"); // document.querySelector('#search-form').submit();
    });
  });
  dropdownElementsTypes.forEach(function (element) {
    element.addEventListener("click", function () {
      ...
      document.getElementById("dropdown-elements-type").classList.toggle("show"); // clearInterval(inst);
      // document.querySelector('#search-form').submit();
    });
  }); // Submit the form when user click on the button
...
var changeResidence = function changeResidence() {
  var residences = ["Auvergne-Rhône Alpes", "Bourgogne-Franche-Comté", "Bretagne", "Centre-Val de Loire", "Corse", "Grand-Est", "Guadeloupe", "Guyane", "Hauts de France", "Ile-de-France", "Martinique", "Mayotte", "Normandie", "Nouvelle-Aquitaine", "Occitanie", "Pays de la Loire", "Provence-Alpes-Côte-d'Azur", "Réunion", "Française ou résidant en France", "Française résidant en outre-mer"];
  var counter = 0;
...
/******/ });
//# sourceMappingURL=application-a0a557dddef0ba6fdbf0.js.map