...
document.addEventListener('turbolinks:load', function () {
  if (document.querySelector("#select-search")) {
    ...
    Object(_plugins_search_index__WEBPACK_IMPORTED_MODULE_4__["updateInput"])();

    if (document.getElementById("text-to-change")) {
      Object(_plugins_search_index__WEBPACK_IMPORTED_MODULE_4__["changeResidence"])();
    }
  }
});
...
var searchIndex = function searchIndex() {
  ...
  window.onclick = function (event) {
    if (event.target.matches('.search-div')) {
      var dropdowns = document.querySelector("#dropdown-elements");
...
var updateInput = function updateInput() {
  var dropdownElements = document.querySelectorAll(".dropdown-content");
...
var changeResidence = function changeResidence() {
  var residences = ["Provence-Alpes-Côte-d'Azur", "Pays de la Loire", "Occitanie", "Nouvelle Aquitaine", "Normandie", "Ile de France", "Hauts de France", "Grand-Est", "Corse", "Centre Val de Loire", "Bretagne", "Bourgogne -Franche Comté", "Auvergne-Rhône Alpes", "Réunion", "Mayotte", "Martinique", "Guyane", "Guadeloupe", "France ou résidant en France"];
  var counter = 0;
  var element = document.getElementById("text-to-change");
...
/******/ });
//# sourceMappingURL=application-20c38b91680b7c215ed6.js.map