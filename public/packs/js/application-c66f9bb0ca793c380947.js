...
/*!************************************************!*\
  !*** ./app/javascript/plugins/progress_bar.js ***!
  \************************************************/
/*! exports provided: searchProgressBar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var searchIndex = function searchIndex() {
  ...
  window.onclick = function (event) {
    if (event.target.matches('.search-div-residence')) {
      var dropdowns = document.querySelector("#dropdown-elements-residence");

      if (dropdowns.classList.contains('show')) {
        dropdowns.classList.remove('show'); // clearInterval(inst);
      }
    }

    if (event.target.matches('.search-div-type')) {
      var _dropdowns = document.querySelector("#dropdown-elements-type");

      if (_dropdowns.classList.contains('show')) {
        _dropdowns.classList.remove('show'); // clearInterval(inst);
...
/******/ });
//# sourceMappingURL=application-c66f9bb0ca793c380947.js.map