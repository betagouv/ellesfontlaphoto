...
help19 = Help.new(
    ...
    start_date: Date.new(2022,1,1),
    end_date: Date.new(2022,02,28),
    help_amount: "50% du budget maximum",
    residence_condition: "Auvergne-Rhône Alpes",
    general_condition: "Réservé à la création artistique ; Ne pas être étudiante",
...
help37 = Help.new(
    ...
    institution_partenaire: ["Association Laurent Troude", "Libération", "Divergence-Images et le festival ImageSingulières"],
...
help39 = Help.new(
    ...
    residence_condition: "Française ou résidant en France",
    general_condition: "Parler anglais ; Avoir un parcours professionnel significatif",
...
help40 = Help.new(
    ...
    start_date: Date.new(2021,11,1),
    end_date: Date.new(2022,01,30),
    help_amount: "750 euros par mois",
...
help41 = Help.new(
    identifiant: "CNAPS",
    institution_name: "CNAP (Centre national des arts plastiques, opérateurs de la politique du ministère de la Culture en matière d’arts plastiques et d’arts visuels.)",
...
help42 = Help.new(
    ...
    specific_condition: "Un projet collectif ne peut faire l'objet que d'une seule demande ; Un refus empêche de candidater l’année suivante ; Cette aide n'est pas cumulable avec les AIC des DRAC  reçues l’année précédente ni avec les soutiens du CNAP (Soutien à un projet Soutien à un projet artistique et soutien pour un projet artistique documentaire (liens). Le cumul est possible avec le secours exceptionnel (lien).) reçus les deux années précédentes ; Cette aide n’est pas cumulable avec la plupart des aides publiques la même année.",
...
help43 = Help.new(
    ...
    start_date: Date.new(2021,11,1),
    end_date: Date.new(2022,02,28),
    help_amount: "5 000, 10 000 ou 15 000 euros",
    residence_condition: "Française ou résidant en France",
    general_condition: "Réservé à la création artistique ; Ne pas être étudiante ; Très sélectif",
    specific_condition: "Un projet collectif ne peut faire l'objet que d'une seule demande ; Un refus empêche de candidater l’année suivante ; Cette aide n'est pas cumulable avec les les AIC des DRAC reçues l’année précédente ni avec les soutiens du CNAP (Soutien à un projet artistique et soutien pour un projet artistique documentaire (liens). Le cumul est possible avec le secours exceptionnel (lien) reçus les deux années précédentes ; Cette aide n’est pas cumulable avec la plupart des aides publiques la même année.",
    selection: "Les demandes sont examinées par une commission, qui émet un avis au vu de la qualité et du professionnalisme du dossier artistique  et de la faisabilité du projet. Ce jugement est porté sur l’ensemble des pièces fournies, y compris de l’équilibre du budget. Le travail de l’artiste doit avoir été validé par le secteur : expositions individuelles, publications, aides…",
