...
const updateInput = () => {
  const types = {
  "<img src='assets/admin/emojis/appareil-photo.png', class='emojis-eflc-large'/> financer du matériel" : "Matériel",
  "<img src='assets/admin/emojis/outils.png', class='emojis-eflc-large'/> financer une production": "Production",
  "<img src='assets/admin/emojis/boule-de-cristal.png', class='emojis-eflc-large'/> un secours exceptionnel": "Aide Sociale",
  "<img src='assets/admin/emojis/maison.png', class='emojis-eflc-large'/> une résidence (artistique)": "Résidence",
  "<img src='assets/admin/emojis/haut-parleur.png', class='emojis-eflc-large'/> financer une diffusion": "Diffusion"
  }
